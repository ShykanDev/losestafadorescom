			...
			<form action="guardar-entrada.php" method="POST" enctype="multipart/form-data">
				<div class="dividir">
					<div class="dos-partes">
						...
						<input type="text" name="titulo" id="nombre" placeholder="Empresa, servicio, producto, banco, persona..." value="<?= $entrada_actual['titulo'] ?>">
						<?php echo isset($_SESSION['errores_entrada']) ? mostrarError($_SESSION['errores_entrada'], 'titulo') : ''; ?>

						<p>Fecha que se realizo la estafa: <span>*</span></p>
						<input type="month" name="fecha_estafa" id="fecha_estafa" value="<?= $entrada_actual['fecha_estafa'] ?>" >
						...
						<input type="text" name="direccion_estafa" id="direccion_estafa" placeholder="Dirección" value="<?= $entrada_actual['direccion_estafa'] ?>" >
						...
						<input type="text" name="other_estafa" id="" placeholder="Agregue otro tipo de Estafa" value="<?= $entrada_actual['other_estafa'] ?>">
					...
					<div class="dos-partes">
						...
						<input type="text" name="medio_estafa" id="" placeholder="Televisión, Redes Sociales, Teléfono, recomendaciones..." value="<?= $entrada_actual['medio_estafa'] ?>">
						...
						<div class="flex">
							...
							<input type="radio" name="demanda" value="Si se realizo proceso legal" id="si-demanda" value="<?= $entrada_actual['demanda'] ?>">
							<?php echo isset($_SESSION['errores_entrada']) ? mostrarError($_SESSION['errores_entrada'], 'demanda') : ''; ?>

							<label for="no-demanda">No</label>
							<input type="radio" name="demanda" id="no-demanda" value="No se realizo proceso legal" value="<?= $entrada_actual['demanda'] ?>">
							<?php echo isset($_SESSION['errores_entrada']) ? mostrarError($_SESSION['errores_entrada'], 'demanda') : ''; ?>
						</div>
						<br>
						...
						<input type="text" name="producto" id="" value="<?= $entrada_actual['producto'] ?>">

						<input type="file" name="imagen" id="" value="<?= $entrada_actual['imagen'] ?>">
